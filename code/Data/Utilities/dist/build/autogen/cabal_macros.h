...
/* package AST-0.1.0.0 */
#define VERSION_AST "0.1.0.0"
#define MIN_VERSION_AST(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
...
#define CURRENT_COMPONENT_ID "Utilities-0.1.0.0-8y2bWPLvt88CCKzv5MHf6"

#define CURRENT_PACKAGE_KEY "Utilities-0.1.0.0-8y2bWPLvt88CCKzv5MHf6"
